...
# Constants
##################################################
path_models = '/lustre/storeB/project/copernicus/svalnav/April_2021/RF_models/Trained_with_buoys/'
#
...
for lt in range(0, len(time_T4)):
	...
	file_model_IB = path_models + 'Direction_201306_202005_without_dayofyear/RF_model_IB_' + rf_str + '_' +  date_str + '_' + lt_str + '.pkl'
	file_model_MA = path_models + 'Speed_201306_202005_without_dayofyear/RF_model_MA_' + rf_str + '_' +  date_str + '_' + lt_str + '.pkl'
	#####
...
output_netcdf.close()
#
os.system('mv ' + output_filename + ' /lustre/storeB/project/copernicus/svalnav/April_2021/Calibrated_forecasts/RF_trained_with_buoys_201306_202005_without_dayofyear/')
###################################################
EOF
