...
# Paths 
#############################################################################################################
path_output = '/lustre/storeB/project/copernicus/svalnav/April_2021/RF_evaluation_data/202006_202105/'
path_data = {}
path_data['Buoys'] = '/lustre/storeB/project/copernicus/svalnav/Data/IABP/Data_T4grid_SIC10/'
path_data['OSISAF'] = '/lustre/storeB/project/copernicus/svalnav/Data_operational_ice_drift_forecasts/Pan_Arctic/OSISAF_SIC_on_T4grid/'
path_data['T4'] = '/lustre/storeB/project/copernicus/svalnav/Data_operational_ice_drift_forecasts/Pan_Arctic/TOPAZ4/'
path_data['ECMWF'] = '/lustre/storeB/project/copernicus/svalnav/Data_operational_ice_drift_forecasts/Pan_Arctic/ECMWF_10m_wind_on_T4grid/'
...
for sd in range(0, len(start_dates)):
	try:
		...
		for fic in range(0, len(feature_var_initial_conditions)):
			...
			file_feature_var = path_data[source_fe_str] + filename[source_fe_str] + ini_dates[sd] + '.nc'
