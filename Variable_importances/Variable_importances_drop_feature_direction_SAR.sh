...
cat > "/lustre/storeB/users/cyrilp/Svalnav/data_processing_files/PROG/Drop_IB_2018_2020_""$SGE_TASK_ID"".py" << EOF
...
path_output = '/lustre/storeB/users/cyrilp/Svalnav/April_2021/Tuning/Results_without_dayofyear/Direction/Drop_feature_training_period_SAR/'
#
...
for dat in range(0, 10):
	...
	for drop_feat in range(0, len(feat_list)):
		...
		#
		Target_test = np.array(df_RF_test['SAR_drift_initial_bearing'])
...
#####################################################################################################
EOF
python3 "/lustre/storeB/users/cyrilp/Svalnav/data_processing_files/PROG/Drop_IB_2018_2020_""$SGE_TASK_ID"".py"
