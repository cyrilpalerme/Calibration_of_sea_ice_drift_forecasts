...
path_output = '/lustre/storeB/users/cyrilp/Svalnav/April_2021/Tuning/Results_without_dayofyear/Direction/Variable_importances_buoys/'
#############################################################################################################
# Input parameters
#############################################################################################################
#
...
for lead_time_start in range(0, 10):
	...
	#
	file_output = 'IB_' + str(date_min_train) + '-' + str(date_max_train) + '_' + rf_param_str + '.dat'
